...
#define PMOVE_TO_KICKPOS 103
#define PKICK_BALL 104
#define PRESET_KICK 105
...
#define LPORT MOTOR_A
#define RPORT MOTOR_D
#define KPORT MOTOR_B
#define TPORT PORT_1
...
void fixDirectionalVector(struct RoboAI* ai){
...
void calculateDirectionToBall(struct RoboAI* ai){
  if(ai == NULL) return;
...
void calculateDirectionToKickPos(struct RoboAI* ai){
  if(ai == NULL) return;
